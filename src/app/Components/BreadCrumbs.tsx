...
export default function BreadCrumbs({ title }: BreadCrumbsProps) {
    return (
        <section className="w-full flex flex-col gap-4 sm:gap-6 xl:gap-8 items-center justify-center fpx fpb pt-30 md:pt-35 max-container primary transition-none">
