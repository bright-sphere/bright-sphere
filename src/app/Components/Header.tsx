...
export default function Header() {
    return (
        <header className="absolute top-0 left-0 right-0 z-50 w-full fpx pt-5 max-container">
            <nav aria-label="Main navigation" className="flex justify-between items-center pl-6 pr-3 py-3 bg-white rounded-full">
                ...
                <span className="relative tm-2 w-[45%] mlg:w-[40%] sm:w-[30%] md:w-[25%] lg:w-[20%] xl:w-[16%] xxl:w-[15%]">
                    <Link href="/" className="cursor-pointer"><Image src="/icons/logo-2.svg" alt="BrightSphere Learning - Home" width={925.14} height={181.18} /></Link>
                </span>
