    ...
    return (
        <footer className="w-full fpx py-6 lg:py-8 primary">
            <div className="flex flex-col lg:flex-row lg:justify-between gap-4 items-center max-container">
                <nav aria-label="Footer navigation" className="flex justify-center gap-3 text-white text-xs mlg:text-sm md:text-base  xxl:text-xl font-open-sans font-semibold order-1 lg:order-2">
