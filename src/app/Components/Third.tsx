...
export default function Third() {
    ...
    return (
        <section id="third-section" className=" grid grid-cols-1 grid-rows-4 sm:grid-cols-2 sm:grid-rows-2  gap-5 md:gap-8 xl:gap-10 fp max-container text-accent text-2xl md:text-3xl  xl:text-4xl xxl:text-[42px] font-semibold font-general-sans">
            {data.map((item, index) => (
